...
Avoid:
- Displaying long-form/static content better suited for a website.
- Complex multi-step workflows beyond inline/fullscreen display modes.
- Ads/upsells/irrelevant messaging.
- Surfacing sensitive/private info in a card.
- Duplicating ChatGPT system functions (e.g., recreating the input composer).

Next steps
- After UX is solid, polish UI using the UI guidelines.
